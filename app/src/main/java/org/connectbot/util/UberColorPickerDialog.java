...
public class UberColorPickerDialog extends Dialog {
    ...
    /**
     * Callback to the creator of the dialog, informing the creator of a new color and notifying
     * that the dialog is about to dismiss.
     */
     ...
     * <p/>
     * You can enable/disable whichever color chooser methods you want by modifying the
     * ENABLED_METHODS switches.  They *should*
     * do all the work required to properly enable/disable methods without losing track of what goes
     * with what and what maps to what.
     * <p/>
     * If you add a new color chooser method, do a text search for "NEW_METHOD_WORK_NEEDED_HERE".
     * That tag indicates all
     * the locations in the code that will have to be amended in order to properly add a new color
     * chooser method.
     * I highly recommend adding new methods to the end of the list.  If you want to try to reorder
     * the list, you're on your own.
     */
    private static class ColorPickerView extends View {
        ...
        /**
         * Initialize the current color chooser's UI (set its color parameters and set its palette
         * and slider values accordingly).
         */
        private void initUI() {
            initHSV1Palette();
        ...
        /**
         * Adjust a Paint which, when painted, dims its underlying object to show the effects of
         * varying value (brightness).
         */
        ...
        /**
         * Wrap Math.round().  I'm not a Java expert.  Is this the only way to avoid writing
        ...
        /**
         * No clue what this does (some sort of average/mean I presume).  It came with the original
         * UberColorPickerDialog
         * in the API Demos and wasn't documented.  I don't feel like spending any time figuring it
         * out, I haven't looked at it at all.
         *
         * @param s
         * @param d
         * @param p
        ...
        /**
         * Came with the original UberColorPickerDialog in the API Demos, wasn't documented.  I
         * believe it takes an array of
         * colors and a value in the range [0,1] and interpolates a resulting color in a seemingly
         * predictable manner.
        ...
        /**
         * Process trackball events.  Used mainly for fine-tuned color adjustment, or alternatively
         * to switch between slider controls.
         */
        @Override
